...
export function SettingsModal({
  ...
  const [focusLtxApiKeyInputOnTabChange, setFocusLtxApiKeyInputOnTabChange] =
    useState(false);
  ...
  const hfApiKeyInputRef = useRef<HTMLInputElement>(null);
  ...
  useEffect(() => {
    if (!isOpen || activeTab !== "apiKeys" || !focusLtxApiKeyInputOnTabChange)
      return;
  ...
  const handleDownloadTextEncoder = async () => {
    ...
    try {
      const response = await backendFetch("/api/text-encoder/download", {
        method: "POST",
      });
      const data = await response.json();
  ...
  const tabs = [
    ...
    { id: "models" as TabId, label: "Models", icon: Database },
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-zinc-900 border border-zinc-700 rounded-xl shadow-2xl w-full max-w-3xl mx-4">
        ...
        {/* Content */}
        <div className="px-6 py-5 space-y-6 h-[60vh] overflow-y-auto w-full">
          {activeTab === "models" && (
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-zinc-400 mt-1">
                          Use LTX API for video generation when an LTX API key
                          is configured.
                        </p>
                      </div>
                      <div
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-zinc-400 mt-1">
                        Fast cloud-based text encoding (~1 second). Requires an
                        LTX API key configured in the API Keys tab.
                      </p>
                    </div>
                    <div
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-zinc-400 mt-1">
                        Run on your computer (~23 seconds). Requires 25 GB
                        download.
                      </p>
                    </div>
                    <div
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-zinc-500 leading-relaxed">
                      ...
                      Only basic technical information is collected — never
                      personal data or generated content.
                    </p>
                  </div>
          ...
          {activeTab === "apiKeys" && (
            <>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Your LTX API key is used for cloud text encoding, prompt
                  enhancement, and Pro generation. Add your key below to unlock
                  these features.
                </p>
              ...
              <div className="space-y-4 pt-4 border-t border-zinc-800">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Your FAL AI key is used for generating images with Z Image
                  Turbo when API generations are enabled.
                </p>
              ...
              <div className="space-y-4 pt-4 border-t border-zinc-800">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Your Gemini API key is used for AI-powered prompt suggestions
                  when filling timeline gaps.
                </p>
              ...
              <div className="space-y-4 pt-4 border-t border-zinc-800">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Your Hugging Face Token allows downloading gated community
                  models. Get one from your HF Account Settings.
                </p>

                <div className="bg-zinc-800/50 rounded-lg p-4 space-y-3">
                  <div className="flex gap-2">
                    <input
                      ref={hfApiKeyInputRef}
                      type="password"
                      value={hfApiKeyInput}
                      onChange={(e) => setHfApiKeyInput(e.target.value)}
                      placeholder={
                        settings.hasHfApiKey
                    ...
                    <button
                      onClick={() => {
                        const trimmed = hfApiKeyInput.trim();
                        if (!trimmed) return;
                        void saveHfApiKey(trimmed);
                        setHfApiKeyInput("");
                      }}
                      disabled={!hfApiKeyInput.trim()}
                      className="px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-500 disabled:bg-zinc-700 disabled:text-zinc-500 disabled:cursor-not-allowed transition-colors whitespace-nowrap"
                    >
                      Save Key
                    </button>
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-3 py-1.5 bg-zinc-700 rounded-lg text-sm text-zinc-400">
                      8
                    </span>
                  </div>
              ...
              <div className="bg-zinc-800/30 rounded-lg p-3 mt-4">
                <p className="text-xs text-zinc-400">
                  <span className="text-blue-400 font-medium">Tip:</span> Lower
          ...
          {activeTab === "promptEnhancer" && (
            <>
              <div className="space-y-4">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Automatically enhances your prompts via the LTX API with rich
                  visual details, sound descriptions, and motion cues to help
                  generate higher quality videos. Control independently for each
                  generation type.
                </p>
                ...
                {!settings.hasLtxApiKey ? (
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-zinc-400 leading-relaxed">
                            Prompt enhancement runs server-side on the LTX API.
                            To use this feature, you need to configure an API
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <div
                          className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-transform pointer-events-none ${
                            settings.promptEnhancerEnabledT2V
                              ? "translate-x-5"
                              : "translate-x-0"
                          }`}
              ...
              {showModelLicense ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-zinc-800/50 rounded-lg p-4 space-y-3">
                    ...
                    <p className="text-xs text-zinc-400">
                      The LTX-2 model is subject to the LTX-2 Community License
                      Agreement, accepted during first-run setup.
                    </p>
                    <Button
                      size="sm"
